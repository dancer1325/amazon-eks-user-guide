# Send control plane logs to CloudWatch Logs<a name="control-plane-logs"></a>
...
* These logs make it easy for you to secure and run your clusters
...
* You can use CloudWatch subscription filters to do real time analysis on the logs or to forward them to other services \(the logs will be Base64 encoded and compressed with the gzip format\)
* see [Amazon CloudWatch logging](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/WhatIsCloudWatchLogs.html)\.
